  ...
  const sources = {
    ...
    sources: [
      ...
      },
      {
        ...
        license: "Public Domain",
        usedFor: "SOC-keyed 2024–2034 projected employment, employment change, growth rates, wages, and annual openings in employment-projections.json",
      },
      {
      ...
      },
      {
        ...
        license: "CC BY 4.0",
        usedFor: "Share of AI and generative-AI job postings as a % of all postings (7-day trailing average); country-level time series in ai-demand.json",
      },
      {
        name: "Challenger, Gray & Christmas — AI-Attributed Job Cuts",
        publisher: "Challenger, Gray & Christmas, Inc.",
        year: 2026,
        url: "https://www.challengergray.com/",
        license: "Proprietary — redistribution requires explicit permission",
        usedFor: "US employer-announced job cuts citing AI as stated reason (monthly and annual totals); ai-layoffs.json — ⚠️ LICENSE RISK: data is proprietary; see data/COMPLIANCE.md",
      },
      {
        name: "AIOE — Occupational Exposure to AI (Felten, Raj & Seamans 2021)",
        publisher: "Ed Felten, Manav Raj, Robert Seamans",
        year: 2021,
        url: "https://github.com/AIOE-Data/AIOE",
        license: "No explicit open license — citation required (SMJ 42(12):2195–2217)",
        usedFor: "Per-SOC AIOE exposure scores (application-ability relatedness) as a supplemental AI-exposure metric; aioe-exposure.json — ⚠️ LICENSE RISK: no open license; see data/COMPLIANCE.md",
      },
      {
        name: "Frey & Osborne (2013) — Computerization Probability by SOC",
        publisher: "Carl Benedikt Frey & Michael A. Osborne, Oxford Martin School",
        year: 2013,
        url: "https://www.oxfordmartin.ox.ac.uk/publications/the-future-of-employment/",
        license: "No open license — academic research; redistribution unclear",
      ...
      },
      {
        ...
        license: "IMF terms (https://www.imf.org/external/terms.htm) — non-commercial redistribution with attribution; commercial use requires IMF permission",
        usedFor: "Overall AI readiness composite (0–1, 178 countries) and four AIPI sub-indices (DI, HCLMP, IEI, RE); global-ai-metrics.json — ⚠️ CONDITIONAL: non-commercial only; see data/COMPLIANCE.md",
      },
      {
        name: "Oxford Insights Government AI Readiness Index 2023",
        publisher: "Oxford Insights",
        year: 2023,
        url: "https://open.africa/dataset/government-ai-readiness-index-2023",
        license: "CC BY 4.0",
        usedFor: "Government AI readiness composite score 0–100 for 193 countries; global-ai-metrics.json",
      },
      {
        ...
        license: "OpenRouter public API/catalog terms — attribution and terms review required before bulk redistribution",
        usedFor: "Provider/model catalog snapshot, endpoint-provider counts, and country-level catalog-proxy mapping; openrouter-models.json — catalog footprint only, not usage, traffic, demand, or deployment geography",
      },
      {
        ...
        license: "Public Domain",
        usedFor: "Monthly job openings, hires, quits, layoffs & separations by industry (JOLTS); jolts.json",
      },
      {
        name: 'OpenAI "GPTs are GPTs" — LLM Occupation Exposure',
        publisher: "OpenAI",
        year: 2023,
        url: "https://github.com/openai/GPTs-are-GPTs",
        license: "MIT",
        usedFor: "Per-SOC GPT-4 exposure ratings (E1/E2/E3 tiers, dv_rating + human annotation); llm-exposure.json",
      },
      {
        name: "Yahoo Finance chart JSON endpoint (unofficial)",
        publisher: "Yahoo Finance / Verizon Media",
        year: 2026,
        url: "https://finance.yahoo.com/",
        license: "Yahoo Terms of Service — redistribution PROHIBITED; no official API license granted",
        usedFor: "Monthly closing prices for AI-sector ETF tickers (XLC, XLK, BOTZ, ARKQ, etc.) used to derive AI market signals; market-ai-signals.json — ⚠️ HIGH LICENSE RISK: Yahoo ToS prohibits redistribution; see data/COMPLIANCE.md",
      },
      {
        name: "AI company adjusted-close fixture / Alpha Vantage refresh path",
        publisher: "FutureGrid / Yahoo Finance / Alpha Vantage",
        year: 2026,
        url: "https://www.alphavantage.co/documentation/",
        license: "Committed fixture bootstrapped from Yahoo chart JSON; Alpha Vantage refresh requires API-key terms compliance",
        usedFor: "Historical adjusted-close observations for public AI-company watchlist; ai-company-stocks.json — descriptive market history only, not investment advice, forecasts, recommendations, or redistribution-cleared market data",
      },
      {
        ...
        license: "Public Domain",
        usedFor: "State-level monthly unemployment rate, employment, and labor force totals; state-labor.json",
      },
      {
        name: "BLS Quarterly Census of Employment and Wages (QCEW) — Annual Area CSVs",
        publisher: "U.S. Bureau of Labor Statistics",
        year: 2025,
        url: "https://www.bls.gov/cew/downloadable-data-files.htm",
        license: "Public Domain",
        usedFor: "State-level annual employment and wages by industry (NAICS) from QCEW; state-qcew.json",
      },
      {
        ...
        license: "Public Records (California Public Records Act / California Labor Code § 1401)",
        usedFor: "Mass layoff and plant closure notices filed with California EDD under the WARN Act; warn-notices.json",
      },
      {
      ...
      },
      {
        ...
        license: "MIT project output; derived from cleared occupation and O*NET inputs",
        usedFor: "SOC-keyed 2016–2025 deterministic job-postings seed for correlation experiments until a licensed historical postings provider is wired in",
      },
      {
        ...
        license: "Public Domain",
        usedFor: "SOC-keyed occupational requirements concepts for occupational-requirements.json: preparation burden, physical presence, work conditions, decision-making, and FutureGrid automation-friction score",
      },
      {
        name: "ILOSTAT — Employment by sex and occupation (thousands) — Annual (EMP_TEMP_SEX_OCU_NB)",
        publisher: "International Labour Organization (ILO)",
        year: 2025,
        url: "https://ilostat.ilo.org/topics/employment/",
        accessEndpoint: "https://rplumber.ilo.org/data/indicator/?id=EMP_TEMP_SEX_OCU_NB_A&lang=en&format=.csv",
        license: "CC BY 4.0",
