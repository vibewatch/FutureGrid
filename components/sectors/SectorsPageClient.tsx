...
/**
 * SectorsPageClient — interactive client island for /sectors.
 *
 * Receives server-derived props only; never imports lib/data raw data files
 * or lib/wage-tier-polarization at runtime. All heavy computation is done
 * in the parent Server Component (app/sectors/page.tsx).
 */
...
import WageTierPolarizationLens from "@/components/sectors/WageTierPolarizationLens";
import Link from "next/link";
import { colorForRisk, formatCurrency } from "@/lib/utils";
import { useState, useMemo } from "react";
import { useT } from "@/lib/i18n/useT";
import type { SectorAggregate } from "@/lib/data";
import type { WageTierPolarization } from "@/lib/wage-tier-polarization";
...
interface SectorsPageClientProps {
  allSectors: SectorAggregate[];
  wageTierData: WageTierPolarization;
}
...
export default function SectorsPageClient({
  ...
  return (
    <div className="mx-auto w-full max-w-[1400px] space-y-8">
      ...
      {/* Wage-Tier Polarization Lens */}
      <WageTierPolarizationLens data={wageTierData} />
