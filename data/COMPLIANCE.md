...
| 26 | `data/international-occupation-mix.json` | [ILOSTAT — Employment by sex and occupation (EMP_TEMP_SEX_OCU_NB)](https://ilostat.ilo.org/topics/employment/) via `https://rplumber.ilo.org/data/indicator/?id=EMP_TEMP_SEX_OCU_NB_A&lang=en&format=.csv` | **CC BY 4.0** ([ILO copyright](https://www.ilo.org/global/copyright/lang--en/index.htm)) | ✅ Yes-with-attribution | "International Labour Organization (ILO)" + URL | ISCO-08 major group (1–9) employment shares for 9 included countries; pairwise occupation-mix dissimilarity; exclusion reasons for CAN/JPN | 🟢 Low | ILO data is CC BY 4.0. Attribution required. No redistribution restriction. Derived values (shares, dissimilarity) are FutureGrid transformations. |
